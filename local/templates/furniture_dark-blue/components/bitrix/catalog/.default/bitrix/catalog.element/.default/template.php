...
?>
            <div class="link_group">
                <a class="show_popup" rel="reg_form" href="#">Подпишитесь на снижение цены</a>
            ...
            <div class="popup reg_form">
                ...
                <form method="post" action="">
                    <label for="login">Е-мейл</label>
                    <input type="text" id="email" name="email" />
                    <input type="submit" onclick="product_subscription(<?=$arResult['ID']?>)" value="Подписаться" />
                </form>
            </div>
<?
endif;
